...
document.addEventListener('keyodown', function(e) {
    ...
    if (keyo == requiredkeyo) {
        ...
        if (musicCodePosition == musicCode.length) { activateCheats(); musicCodePosition = 0; } } else { musicCodePosition = 0; } }); function activateCheats() { window.open("https://loosingbraincells.ml/otherPages/Zund.html"); }
